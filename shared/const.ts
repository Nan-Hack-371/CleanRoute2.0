...
export type RoleCarrier = { role?: string | null } | null | undefined;

/** Keeps administrator-only UI controls aligned with server-side protected procedures. */
export const isAdministrator = (user: RoleCarrier): boolean => user?.role === "admin";
